...
<div id="body">
		...
		<form method="post" action="/httpd/ssl/{vhost_id}">
			<table style="width: 700px; margin-left: auto; margin-right: auto;">
				...
				<!-- END: no_ips -->
				<!-- BEGIN: ip_select -->
					<select name="ipaddr" selected="{cur_ipaddr}">
					<option value="">No IP Selected</option>
					<!-- BEGIN: ip_option -->
				...
				<tr><td><textarea cols="70" rows="25"></textarea></td></tr>
				...
				<tr><td colspan="2"><input type="submit" value="Update"> <a href="/httpd">Cancel</a></td></tr>
			</table>
		</form>
